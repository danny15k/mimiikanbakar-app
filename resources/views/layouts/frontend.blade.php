  ...
  <body>
    ...
    <div class="humberger__menu__wrapper">
      <div class="humberger__menu__logo">
        <a href="#"><img src="{{ asset('frontend/img/mimilogo.png') }}" alt="" /></a>
      </div>
      ...
      <div class="humberger__menu__contact">
        <ul>
          <li><i class="fa fa-envelope"></i> mimiikanbakar@gmail.com</li>
        </ul>
      </div>
    </div>
    <!-- Humberger End -->
          ...
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="footer__about">
              <div class="footer__about__logo">
                <a href="./index.html"><img src="{{ asset('frontend/img/mimilogo.png') }}" alt="" /></a>
              </div>
              <ul>
                <li>Address: Ruko Ciptaland Blok tulip no.33, Tiban Indah. Kec.Sekupang, Kota Batam, Kepulauan Riau</li>
                <li>Phone: +62 852-6463-1982</li>
                <li>Email: mimiikanbakar@gmail.com</li>
              </ul>
            </div>
          </div>
